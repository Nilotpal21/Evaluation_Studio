...
3. **Follow CLAUDE.md rules**: No console.log, no `any`, no `.catch(() => {})`, Zod `z.string().min(1)` for IDs, error envelope format, etc.
...
- "E2E tests must NOT mock existing components. See CLAUDE.md E2E Test Standards."
