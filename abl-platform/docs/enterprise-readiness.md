...
| Project-Level RBAC      | Owner, Developer, Viewer roles per project                                                                                       | `apps/runtime/src/middleware/rbac.ts`                                                |
...
| Multi-Version CEK Wrapping     | v1 (PBKDF2), v2 (KMS-wrapped), v3 (tenant-scoped)                     | `packages/database/src/mongo/plugins/encryption.plugin.ts`         |
...
| Feature              | Implementation                                       | Files                                                 |
| -------------------- | ---------------------------------------------------- | ----------------------------------------------------- |
| Project-Level RBAC   | Owner, Developer, Viewer roles                       | `apps/runtime/src/middleware/rbac.ts`                 |
