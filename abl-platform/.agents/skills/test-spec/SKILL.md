...
- Include: "Answer these clarifying questions for the test spec: <feature-name>. Read the feature spec at docs/features/<slug>.md, existing tests, and AGENTS.md E2E standards."
