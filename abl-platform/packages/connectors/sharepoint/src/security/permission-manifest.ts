/**
 * SharePoint Connector — Permission Manifest
 *
 * Single source of truth for all permission justification, data handling,
 * and compliance documentation. Consumed by email generator, security
 * export, and Studio UI components.
 */

import type { PermissionManifest } from '@agent-platform/connectors-base';
...
export const SHAREPOINT_PERMISSION_MANIFEST: PermissionManifest = {
  ...
  // ─── Conditional Scopes (feature-dependent) ─────────────────────────
  ...
  // ─── Permissions NOT Requested (trust signal) ───────────────────────
