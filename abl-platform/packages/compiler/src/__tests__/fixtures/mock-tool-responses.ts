/**
 * Static mock tool responses for testing.
 * Moved from packages/compiler/src/platform/constructs/executors/mock-responses.ts
 * to keep test data out of production code.
 */
