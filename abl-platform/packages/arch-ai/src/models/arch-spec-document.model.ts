...
export interface IArchSpecDocumentRecord {
  _id: string;
  tenantId: string;
  userId: string;
  sessionId: string;
...
const ArchSpecDocumentSchema = new Schema<IArchSpecDocumentRecord>(
  {
  ...
  { timestamps: true, collection: 'arch_spec_documents_v4' },
);
...
export const ArchSpecDocumentModel =
  (mongoose.models.ArchSpecDocumentModel as mongoose.Model<IArchSpecDocumentRecord>) ||
  model<IArchSpecDocumentRecord>('ArchSpecDocumentModel', ArchSpecDocumentSchema);
