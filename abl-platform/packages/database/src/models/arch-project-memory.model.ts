...
export interface IArchProjectMemory {
  _id: string;
  tenantId: string;
  projectId: string;
...
const ArchProjectMemorySchema = new Schema<IArchProjectMemory>(
  {
  ...
  { timestamps: true, collection: 'arch_project_memories' },
);
...
export const ArchProjectMemory =
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  (mongoose.models.ArchProjectMemory as any) ||
  model<IArchProjectMemory>('ArchProjectMemory', ArchProjectMemorySchema);
