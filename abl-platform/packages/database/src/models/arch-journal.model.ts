...
const ArchJournalSchema = new Schema<IArchJournal>(
  {
  ...
  { timestamps: true, collection: 'arch_journal' },
);
...
export const ArchJournal =
  (mongoose.models.ArchJournal as mongoose.Model<IArchJournal>) ||
  model<IArchJournal>('ArchJournal', ArchJournalSchema);
