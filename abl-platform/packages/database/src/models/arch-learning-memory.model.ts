...
export interface IArchLearningMemory {
  _id: string;
...
const ArchLearningMemorySchema = new Schema<IArchLearningMemory>(
  {
  ...
  { timestamps: true, collection: 'arch_learning_memories' },
);
...
export const ArchLearningMemory =
  (mongoose.models.ArchLearningMemory as any) ||
  model<IArchLearningMemory>('ArchLearningMemory', ArchLearningMemorySchema);
