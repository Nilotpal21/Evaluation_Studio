/**
 * POST /api/projects/:id/agent-assist-bindings/:bindingId/disable
 *
 * Proxies to runtime /api/projects/:projectId/agent-assist-bindings/:bindingId/disable
 */
...
export const POST = withRouteHandler(
  ...
  async ({ request, tenantId, params }) => {
    try {
      const runtimeUrl = `${RUNTIME_BASE}/api/projects/${encodeURIComponent(params.id)}/agent-assist-bindings/${encodeURIComponent(params.bindingId)}/disable`;
