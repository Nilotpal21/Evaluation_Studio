/**
 * POST /api/projects/:id/connectors/:connectorName/triggers/:triggerName/props/:propName/options
 *
 * Resolves dynamic dropdown options for a connector-trigger prop using the given
...
export const POST = withRouteHandler(
  ...
  async ({ request, tenantId, params }) => {
    ...
    return proxyToWorkflowEngine(
      request,
      `/api/v1/connectors/${connectorName}/triggers/${triggerName}/props/${propName}/options`,
      {
        method: 'POST',
        tenantId,
        body: {
