 ...
 *
 * Public proxy: forwards Kore.ai Agent Assist session-create requests to runtime.
 *
...
export async function POST(
  ...
  const runtimePath = `/api/v2/apps/${encodeURIComponent(appId)}/environments/${encodeURIComponent(envName)}/sessions`;
