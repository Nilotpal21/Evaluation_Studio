    ...
    <RadixTooltip.Root delayDuration={delay}>
      ...
      <RadixTooltip.Portal>
        <RadixTooltip.Content
          ...
          className={twMerge(
            clsx(
              'z-50 px-2.5 py-1.5 text-xs font-medium rounded-md bg-foreground text-background shadow-md',
        ...
        >
          {content}
          <RadixTooltip.Arrow className={twMerge(clsx('fill-foreground', arrowClassName))} />
        </RadixTooltip.Content>
      </RadixTooltip.Portal>
    </RadixTooltip.Root>
  );
