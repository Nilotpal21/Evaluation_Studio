      ...
      {showPageSize && onPageSizeChange ? (
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-2 py-1 text-xs rounded-md border border-default bg-background text-foreground focus:outline-none focus:border-border-focus"
          >
        ...
        {getPageNumbers().map((item, idx) =>
          item === 'ellipsis' ? (
            ...
            <button
              ...
              className={clsx(
                'min-w-7 h-7 px-1.5 rounded-md text-xs font-medium transition-default',
                item === page
