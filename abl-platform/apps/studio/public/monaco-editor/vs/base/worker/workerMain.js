      ...
      _applyPaths(d) {
        ...
        for (let L = 0, h = this.sortedPathsRules.length; L < h; L++)
          if (((g = this.sortedPathsRules[L]), q.Utilities.startsWith(d, g.from))) {
            let o = [];
            for (let C = 0, e = g.to.length; C < e; C++) o.push(g.to[C] + d.substr(g.from.length));
            return o;
          }
        return [d];
      }
        ...
        if (!q.Utilities.endsWith(g, '.js') && !q.Utilities.isAbsolutePath(g)) {
          ...
          for (let h = 0, o = L.length; h < o; h++)
            (this.isBuild() && L[h] === 'empty:') ||
              (q.Utilities.isAbsolutePath(L[h]) || (L[h] = this.options.baseUrl + L[h]),
...
//# sourceURL=${C}`),
    ...
    class d {
      ...
      load(o, C, e, a) {
        ...
        if (/^node\|/.test(C)) {
          ...
          this._readSourceAndCachedData(S, y, f, (_, r, s, l) => {
            ...
            (this._handleCachedData(v, p, y, E && !s, o), this._verifyCachedData(v, p, y, l, o));
          });
        }
      }
      ...
      _createAndWriteCachedData(o, C, e, a) {
        let u = Math.ceil(
            a.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random()),
          ),
          c = -1,
          m = 0,
          f;
              ...
              if (!(w.length === 0 || w.length === c || m >= 5)) {
                ...
                ((c = w.length),
                  this._fs.writeFile(e, Buffer.concat([f, w]), (E) => {
                    (E && a.getConfig().onError(E), a.getRecorder().record(63, e), S());
                  }));
              }
            },
            u * Math.pow(4, m++),
  ...
  (function (q) {
    ...
    class g {
      ...
      _normalizeDependencies(h, o) {
        let C = [],
          e = 0;
        for (let a = 0, u = h.length; a < u; a++) C[e++] = this._normalizeDependency(h[a], o);
        return C;
      }
      ...
      _loadPluginDependency(h, o) {
        ...
        ((C.error = (e) => {
          ...
          h.load(o.pluginParam, this._createRequire(n.ROOT), C, this._config.getOptionsLiteral()));
      }
      _resolve(h) {
          ...
          for (let C = 0, e = o.length; C < e; C++) {
            ...
            if (this._hasDependencyPath(a.id, h.id)) {
              ...
              (c.reverse(),
                c.push(a.id),
                console.warn(
                  c.map((m) => this._moduleIdProvider.getStrModuleId(m)).join(` => 
`),
                ),
                h.unresolvedDependenciesCount--);
              continue;
  ...
  ((function (q) {
      ...
      function m(f, S, w, E) {
        ...
        if (!f || f.length === 0)
          return w({
            ...
            getConfiguredDefaultLocale: () => {
              var b;
              return (b = _.availableLanguages) === null || b === void 0 ? void 0 : b['*'];
            },
          });
        ...
        const p = (b) => {
          (Array.isArray(b)
            ...
            (b.getConfiguredDefaultLocale = () => {
              var v;
              return (v = _.availableLanguages) === null || v === void 0 ? void 0 : v['*'];
            }),
            w(b));
        };
    ...
    (function () {
      ...
      function M(C, e) {
        ...
        try {
          return (a = self.trustedTypes) === null || a === void 0 ? void 0 : a.createPolicy(C, e);
        } catch (u) {
          console.warn(u);
          return;
        }
      ...
      function i() {
        try {
          return (
            (A ? globalThis.eval(A.createScript('', 'true')) : new Function('true')).call(
              globalThis,
            ),
            !0
          );
...
//# sourceURL=${a}`),
      ...
      class z {
        ...
        findLastMaxBy(O) {
          let I,
            V = !0;
          return (
            this.iterate((H) => ((V || R.isGreaterThan(O(H, I))) && ((V = !1), (I = H)), !0)),
            I
          );
        }
      }
    ...
    X(J[32], Z([0, 1]), function (q, n) {
      ...
      class M {
        ...
        get(d) {
          ...
          return (
            this.lastArgKey !== g && ((this.lastArgKey = g), (this.lastCache = this.fn(d))),
            this.lastCache
          );
        }
      }
    ...
    X(J[33], Z([0, 1]), function (q, n) {
      ...
      class g {
        ...
        lighten(h) {
          return new g(new i(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * h, this.hsla.a));
        }
        darken(h) {
          return new g(new i(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * h, this.hsla.a));
        }
        ...
        opposite() {
          return new g(new A(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
        }
        makeOpaque(h) {
        ...
        (function (L) {
          ...
          (function (o) {
            ...
            (function (e) {
              ...
              e.formatHexA = w;
              function E(r) {
                return r.isOpaque() ? L.Format.CSS.formatHex(r) : L.Format.CSS.formatRGBA(r);
              }
              e.format = E;
              function y(r) {
                const s = r.length;
                ...
                if (s === 5) {
                  const l = _(r.charCodeAt(1)),
                    ...
                    b = _(r.charCodeAt(3)),
                    v = _(r.charCodeAt(4));
                  return new L(new A(16 * l + l, 16 * p + p, 16 * b + b, (16 * v + v) / 255));
                }
                return null;
              }
              e.parseHex = y;
...
` +
    ...
    X(J[21], Z([0, 1]), function (q, n) {
      ...
      (function (A) {
        ...
        function* E(_, r, s = _.length) {
          for (
            r < 0 && (r += _.length), s < 0 ? (s += _.length) : s > _.length && (s = _.length);
            r < s;
            r++
          )
            yield _[r];
    ...
    X(J[35], Z([0, 1]), function (q, n) {
      ...
      (function () {
        ...
        for (const m of a) {
          ...
          (_ && (n.EVENT_KEY_CODE_MAP[_] = E), r && (n.NATIVE_WINDOWS_KEY_CODE_TO_KEY_CODE[r] = E));
        }
    ...
    X(J[23], Z([0, 1]), function (q, n) {
      ...
      class A {
        ...
        constructor(d) {
          ((this._now =
            M && d === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance)),
    ...
    X(J[9], Z([0, 1, 5, 20, 13, 22, 23]), function (q, n, M, A, i, d, g) {
      ...
      (function (b) {
        ...
        function U(...K) {
          return (j, G = null, Q) => {
            const ee = (0, i.combinedDisposable)(...K.map((ne) => ne((P) => j.call(G, P))));
            return O(ee, Q);
          };
        }
        b.any = U;
            ...
            onWillAddFirstListener() {
              B = K((ce) => {
                (te++,
                  ...
                  (ie = () => {
                    const se = W;
                    ((W = void 0), ($ = void 0), (!Q || te > 1) && ue.fire(se), (te = 0));
                  }),
                  typeof G == 'number'
        ...
        b.debounce = I;
        function V(K, j = 0, G) {
          return b.debounce(K, (Q, ee) => (Q ? (Q.push(ee), Q) : [ee]), j, void 0, !0, void 0, G);
        }
        b.accumulate = V;
        ...
        function fe(K) {
          return (j, G, Q) => {
            ...
            return (Q instanceof i.DisposableStore ? Q.add(B) : Array.isArray(Q) && Q.push(B), B);
          };
        }
      ...
      class a {
        ...
        check(v, R) {
          ...
          if (
            (this._stacks.set(v.value, D + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)
          ) {
...
`),
      ...
      class S {
        ...
        dispose() {
          ...
          if (!this._disposed) {
            ...
            ((N =
              (R = this._options) === null || R === void 0 ? void 0 : R.onDidRemoveLastListener) ===
              null ||
              N === void 0 ||
              N.call(R),
          ...
          return (
            ((v = this._event) !== null && v !== void 0) ||
              (this._event = (R, N, D) => {
                ...
                (this._leakageMon &&
                  ...
                  this._listeners
                    ? this._listeners instanceof c
                      ? (((z = this._deliveryQueue) !== null && z !== void 0) ||
                ...
                return (
                  D instanceof i.DisposableStore ? D.add(V) : Array.isArray(D) && D.push(V),
                  V
                );
              }),
            this._event
        ...
        _removeListener(v) {
          ...
          if (
            ((N =
              (R = this._options) === null || R === void 0 ? void 0 : R.onWillRemoveListener) ===
              null ||
              N === void 0 ||
              N.call(R, this),
            !this._listeners)
        ...
        _deliver(v, R) {
          ...
          if (!v) return;
          const D =
            ((N = this._options) === null || N === void 0 ? void 0 : N.onListenerError) ||
            M.onUnexpectedError;
          if (!D) {
            v.value(R);
            return;
      ...
      function l(P, B, W = 0, $ = P.length, te = 0, ie = B.length) {
        for (; W < $ && te < ie; W++, te++) {
          let ce = P.charCodeAt(W),
            se = B.charCodeAt(te);
          if (ce === se) continue;
          if (ce >= 128 || se >= 128) return r(P.toLowerCase(), B.toLowerCase(), W, $, te, ie);
      ...
      class c {
        ...
        update(f) {
          ...
          let E = this._buffLen,
            ...
            _,
            r;
          for (y !== 0 ? ((_ = y), (r = -1), (y = 0)) : ((_ = f.charCodeAt(0)), (r = 0)); ; ) {
            let s = _;
            if (M.isHighSurrogate(_))
              if (r + 1 < S) {
                const l = f.charCodeAt(r + 1);
                M.isLowSurrogate(l) ? (r++, (s = M.computeCodePoint(_, l))) : (s = 65533);
              } else {
                y = _;
                break;
              }
        ...
        _push(f, S, w) {
          return (
            w < 128
              ? (f[S++] = w)
              : w < 2048
                ? ((f[S++] = 192 | ((w & 1984) >>> 6)), (f[S++] = 128 | ((w & 63) >>> 0)))
                : w < 65536
                  ? ((f[S++] = 224 | ((w & 61440) >>> 12)),
                    (f[S++] = 128 | ((w & 4032) >>> 6)),
                    (f[S++] = 128 | ((w & 63) >>> 0)))
      ...
      class o {
        ...
        ComputeDiffRecursive(e, a, u, c, m) {
          ...
          if (e > a || u > c) {
            ...
            return (
              u <= c
                ? (g.Assert(e === a + 1, 'originalStart should only be one more than originalEnd'),
                ...
                : e <= a
                  ...
                  : (g.Assert(
                    ...
                    g.Assert(u === c + 1, 'modifiedStart should only be one more than modifiedEnd'),
                    (_ = [])),
              _
            );
          }
          ...
          if (!m[0]) {
            ...
            return (
              m[0]
                ? (r = [new M.DiffChange(E + 1, a - (E + 1) + 1, y + 1, c - (y + 1) + 1)])
        ...
        WALKTRACE(e, a, u, c, m, f, S, w, E, y, _, r, s, l, p, b, v, R) {
          ...
          if (((N = x.getReverseChanges()), R[0])) {
            ...
            if (N !== null && N.length > 0) {
              ...
              ((O = Math.max(O, V.getOriginalEnd())), (I = Math.max(I, V.getModifiedEnd())));
            }
            ...
            do {
              ...
              (O === T || (O < F && y[O - 1] >= y[O + 1])
                ...
                : ((_ = y[O - 1]),
                  ...
                  (U = O - 1 - m)),
                k >= 0 &&
                  ((y = this.m_reverseHistory[k]), (m = y[0]), (T = 1), (F = y.length - 1)));
            } while (--k >= -1);
            D = x.getChanges();
          }
        ...
        ComputeRecursionPoint(e, a, u, c, m, f, S) {
          ...
          for (let U = 1; U <= l / 2 + 1; U++) {
            ...
            for (let I = y; I <= _; I += 2) {
              (I === y || (I < _ && b[I - 1] < b[I + 1]) ? (w = b[I + 1]) : (w = b[I - 1] + 1),
                (E = w - (I - R) - D));
              const V = w;
              ...
              if (
                ...
                return (
                  ...
                  V <= v[I] && 1447 > 0 && U <= 1447 + 1
                    ? this.WALKTRACE(R, y, _, D, N, r, s, x, b, v, w, a, m, E, c, f, F, S)
                    : null
                );
            }
            const O = (z - e + (k - u) - U) / 2;
            ...
            for (let I = r; I <= s; I += 2) {
              (I === r || (I < s && v[I - 1] >= v[I + 1]) ? (w = v[I + 1] - 1) : (w = v[I - 1]),
                (E = w - (I - N) - x));
              const V = w;
        ...
        PrettifyChanges(e) {
          for (let a = 0; a < e.length; a++) {
            ...
            for (
              ...
              (!S ||
                this.ModifiedElementsAreEqual(u.modifiedStart, u.modifiedStart + u.modifiedLength));
            ) {
          ...
          for (let a = e.length - 1; a >= 0; a--) {
            ...
            if (a > 0) {
              const _ = e[a - 1];
              ((c = _.originalStart + _.originalLength), (m = _.modifiedStart + _.modifiedLength));
            }
    ...
    X(J[25], Z([0, 1]), function (q, n) {
      ...
      function m(f, S) {
        if (M(S)) {
          if (typeof f !== S) throw new Error(`argument does not match constraint: typeof ${S}`);
        } else if (u(S)) {
          try {
            if (f instanceof S) return;
          } catch {}
          if ((!C(f) && f.constructor === S) || (S.length === 1 && S.call(void 0, f) === !0))
            return;
          throw new Error(
      ...
      function i(u) {
        ...
        for (; c.length > 0; ) {
          ...
          for (const f in m)
            if (d.call(m, f)) {
              const S = m[f];
              typeof S == 'object' && !Object.isFrozen(S) && !(0, M.isTypedArray)(S) && c.push(S);
            }
        }
        return u;
      }
    ...
    X(J[27], Z([0, 1, 26]), function (q, n, M) {
      ...
      class A {
        ...
        get(g) {
          return g >= 0 && g < 256 ? this._asciiMap[g] : this._map.get(g) || this._defaultValue;
        }
        clear() {
    ...
    X(J[3], Z([0, 1, 5]), function (q, n, M) {
      ...
      class A {
        ...
        join(g) {
          return new A(Math.min(this.start, g.start), Math.max(this.endExclusive, g.endExclusive));
        }
        intersect(g) {
      ...
      class i {
        ...
        addRange(g) {
          let L = 0;
          for (; L < this._sortedRanges.length && this._sortedRanges[L].endExclusive < g.start; )
            L++;
          let h = L;
          for (; h < this._sortedRanges.length && this._sortedRanges[h].start <= g.endExclusive; )
            h++;
        ...
        intersectsStrict(g) {
          ...
          for (; L < this._sortedRanges.length && this._sortedRanges[L].endExclusive <= g.start; )
            L++;
          return L < this._sortedRanges.length && this._sortedRanges[L].start < g.endExclusive;
        }
      ...
      class A {
        ...
        static containsRange(d, g) {
          return !(
            ...
            (g.startLineNumber === d.startLineNumber && g.startColumn < d.startColumn) ||
        ...
        static plusRange(d, g) {
          ...
          return (
            g.startLineNumber < d.startLineNumber
              ...
              : g.startLineNumber === d.startLineNumber
                ? ((L = g.startLineNumber), (h = Math.min(g.startColumn, d.startColumn)))
    ...
    X(J[10], Z([0, 1, 5, 3, 2, 11]), function (q, n, M, A, i, d) {
      ...
      class g {
        ...
        mapToLineArray(o) {
          const C = [];
          for (let e = this.startLineNumber; e < this.endLineNumberExclusive; e++) C.push(o(e));
          return C;
        }
        forEach(o) {
      ...
      class L {
        ...
        addRange(o) {
          ...
          if (C === e) this._normalizedRanges.splice(C, 0, o);
            ...
            const a = this._normalizedRanges[C].join(this._normalizedRanges[e - 1]).join(o);
    ...
    X(J[8], Z([0, 1, 7, 5, 3]), function (q, n, M, A, i) {
      ...
      class g {
            ...
            (0, M.forEachAdjacent)(e, (c, m) => {
              u.push(
                g.fromOffsetPairs(
                  ...
                  m
                    ? m.getStarts()
                    : new L(a, (c ? c.seq2Range.endExclusive - c.seq1Range.endExclusive : 0) + a),
                ),
              );
            }),
            u
        ...
        deltaStart(e) {
          return e === 0 ? this : new g(this.seq1Range.deltaStart(e), this.seq2Range.deltaStart(e));
        }
        deltaEnd(e) {
          return e === 0 ? this : new g(this.seq1Range.deltaEnd(e), this.seq2Range.deltaEnd(e));
        }
        intersect(e) {
      ...
      class i {
        compute(o, C, e = A.InfiniteTimeout.instance) {
          ...
          const a = o,
            u = C;
          function c(s, l) {
            for (; s < a.length && l < u.length && a.getElement(s) === u.getElement(l); )
              (s++, l++);
            return s;
          }
          let m = 0;
          ...
          for (;;) {
            ...
            if (
              ((s !== _ || l !== r) &&
                y.push(new A.SequenceDiff(new M.OffsetRange(s, _), new M.OffsetRange(l, r))),
              !E)
            )
              break;
          ...
          if (_.seq1Range.isEmpty || _.seq2Range.isEmpty) {
            ...
            for (
              ...
              !(
                ...
                m.getElement(_.seq2Range.start - s) !== m.getElement(_.seq2Range.endExclusive - s)
              );
              s++
            );
            if ((s--, s === r)) {
        ...
        for (let E = 0; E < S.length - 1; E++) {
          ...
          if (_.seq1Range.isEmpty || _.seq2Range.isEmpty) {
            ...
            for (
              ...
              s < r &&
              !(
                !c.isStronglyEqual(_.seq1Range.start + s, _.seq1Range.endExclusive + s) ||
                !m.isStronglyEqual(_.seq2Range.start + s, _.seq2Range.endExclusive + s)
              );
              s++
            );
            if (s === r) {
        ...
        for (const _ of f) {
          let r = function (v, R) {
            ...
            if (!w || !w.s1Range.containsRange(v) || !w.s2Range.containsRange(R))
              if (w && !(w.s1Range.endExclusive < v.start && w.s2Range.endExclusive < R.start)) {
              ...
              } else (E(), (w = { added: 0, deleted: 0, count: 0, s1Range: v, s2Range: R }));
      ...
      function e(c, m) {
        ...
        for (; c.length > 0 || m.length > 0; ) {
          const S = c[0],
            w = m[0];
          let E;
          (S && (!w || S.seq1Range.start < w.seq1Range.start) ? (E = c.shift()) : (E = m.shift()),
      ...
      function a(c, m, f) {
        ...
        do {
          ...
          for (let _ = 1; _ < S.length; _++) {
            ...
            const r = S[_],
              s = y[y.length - 1];
            l(s, r) ? ((E = !0), (y[y.length - 1] = y[y.length - 1].join(r))) : y.push(r);
          }
          S = y;
        } while (w++ < 10 && E);
        return S;
      ...
      function u(c, m, f) {
        ...
        do {
          ...
          for (let r = 1; r < S.length; r++) {
            let p = function (v, R) {
              ...
              return (
                Math.pow(Math.pow(Y(T * 40 + F), 1.5) + Math.pow(Y(U * 40 + z), 1.5), 1.5) +
                  Math.pow(Math.pow(Y(k * 40 + O), 1.5) + Math.pow(Y(I * 40 + V), 1.5), 1.5) >
                (H ** 1.5) ** 1.5 * 1.3
              );
            };
            const s = S[r],
              l = _[_.length - 1];
            p(l, s) ? ((E = !0), (_[_.length - 1] = _[_.length - 1].join(s))) : _.push(s);
          }
          S = _;
        } while (w++ < 10 && E);
        const y = [];
        return (
          (0, M.forEachWithNeighbors)(S, (_, r, s) => {
            ...
            const R = c.getText(new A.OffsetRange(r.seq1Range.endExclusive, b.endExclusive));
...
`);
    ...
    X(J[15], Z([0, 1]), function (q, n) {
      ...
      class M {
        constructor(g, L) {
          ((this.width = g), (this.height = L), (this.array = []), (this.array = new Array(g * L)));
        }
        get(g, L) {
    ...
    X(J[45], Z([0, 1, 3, 8, 15]), function (q, n, M, A, i) {
      ...
      class d {
        compute(L, h, o = A.InfiniteTimeout.instance, C) {
            ...
            for (let _ = 0; _ < h.length; _++) {
              ...
              L.getElement(y) === h.getElement(_)
                ? (y === 0 || _ === 0 ? (l = 0) : (l = e.get(y - 1, _ - 1)),
                  y > 0 && _ > 0 && a.get(y - 1, _ - 1) === 3 && (l += u.get(y - 1, _ - 1)),
                  (l += C ? C(y, _) : 1))
                : (l = -1);
          ...
          function S(y, _) {
            ((y + 1 !== m || _ + 1 !== f) &&
              c.push(new A.SequenceDiff(new M.OffsetRange(y + 1, m), new M.OffsetRange(_ + 1, f))),
              (m = y),
              (f = _));
          }
          let w = L.length - 1,
...
`.charCodeAt(0),
        ...
        extendToFullLines(u) {
          var c, m;
          const f =
              (c = (0, M.findLastMonotonous)(this.firstCharOffsetByLine, (w) => w <= u.start)) !==
                null && c !== void 0
                ? c
                : 0,
            S =
      ...
      class i extends A {
        ...
        flip() {
          ...
          return new i(
            this.modified,
            this.original,
            (L = this.innerChanges) === null || L === void 0 ? void 0 : L.map((h) => h.flip()),
          );
        }
      }
...
`).length >= 15 && u(D, (T) => T.length >= 2) >= 2
          ...
          for (const x of E) {
            ...
            for (
              ...
              (b.forEach(U, ({ range: O }) => {
                for (const V of T)
                  if (
                    V.originalLineRange.endLineNumberExclusive + 1 === O.endLineNumberExclusive &&
                    V.modifiedLineRange.endLineNumberExclusive + 1 === z.endLineNumberExclusive
                  ) {
          ...
          for (let x = 0; x < p.length; x++) {
            const T = p[x],
              ...
              k = D.findLastMonotonous(
                (Y) => Y.original.startLineNumber < T.original.endLineNumberExclusive,
              ),
              O = (0, d.findLastMonotonous)(
                E,
                (Y) => Y.modified.startLineNumber < T.modified.endLineNumberExclusive,
              ),
              I = Math.max(
            ...
            V > 0 &&
              (N.addRange(
                new L.LineRange(T.original.startLineNumber - V, T.original.startLineNumber),
              ),
              R.addRange(
                new L.LineRange(T.modified.startLineNumber - V, T.modified.startLineNumber),
              ));
            let H;
            for (H = 0; H < I; H++) {
            ...
            (y = y.filter((r) => {
              const s =
                  _.findLastMonotonous(
                    (b) => b.original.startLineNumber < r.original.endLineNumberExclusive,
                  ) || new A.LineRangeMapping(new L.LineRange(1, 1), new L.LineRange(1, 1)),
                l = (0, d.findLastMonotonous)(
                  E,
                  (b) => b.modified.startLineNumber < r.modified.endLineNumberExclusive,
                );
              return s !== l;
            })),
            y
      ...
      function (q, n, M, A, i, d, g, L, h, o, C, e, a, u, c, m) {
        ...
        class f {
          ...
          computeDiff(y, _, r) {
            ...
            if ((y.length === 1 && y[0].length === 0) || (_.length === 1 && _[0].length === 0))
          ...
          computeMoves(y, _, r, s, l, p, b) {
            return (0, C.computeMovedLines)(y, _, r, s, l, p).map((N) => {
              const D = this.refineDiff(
                  _,
                  r,
                  new L.SequenceDiff(N.original.toOffsetRange(), N.modified.toOffsetRange()),
                  p,
                  b,
                ),
        ...
        function S(E, y, _, r = !1) {
          ...
          for (const l of (0, M.groupAdjacentBy)(
            E.map((p) => w(p, y, _)),
            (p, b) =>
              p.original.overlapOrTouch(b.original) || p.modified.overlapOrTouch(b.modified),
          )) {
            const p = l[0],
              b = l[l.length - 1];
            s.push(
            ...
            (0, A.assertFn)(() =>
              !r && s.length > 0 && s[0].original.startLineNumber !== s[0].modified.startLineNumber
                ...
                : (0, A.checkAdjacentItems)(
                    s,
                    (l, p) =>
                      p.original.startLineNumber - l.original.endLineNumberExclusive ===
                        p.modified.startLineNumber - l.modified.endLineNumberExclusive &&
                      l.original.endLineNumberExclusive < p.original.startLineNumber &&
                      l.modified.endLineNumberExclusive < p.modified.startLineNumber,
                  ),
            ),
            s
          );
        ...
        function w(E, y, _) {
          ...
          (E.modifiedRange.endColumn === 1 &&
            ...
            (s = -1),
            E.modifiedRange.startColumn - 1 >= _[E.modifiedRange.startLineNumber - 1].length &&
              E.originalRange.startColumn - 1 >= y[E.originalRange.startLineNumber - 1].length &&
    ...
    X(J[48], Z([0, 1, 24, 31, 16, 6, 2, 12, 10]), function (q, n, M, A, i, d, g, L, h) {
      ...
      class a {
        constructor(r) {
          const s = [],
            l = [];
          for (let p = 0, b = r.length; p < b; p++) ((s[p] = w(r[p], 1)), (l[p] = E(r[p], 1)));
      ...
      function m(_) {
        ...
        for (let l = 1, p = _.length; l < p; l++) {
          ...
          Math.min(v, R) < o
            ? ((s.originalLength = b.originalStart + b.originalLength - s.originalStart),
        ...
        static createFromDiffResult(r, s, l, p, b, v, R) {
          ...
          if (
            ...
            const U = l.createCharSequence(
              ...
              z = p.createCharSequence(r, s.modifiedStart, s.modifiedStart + s.modifiedLength - 1);
            if (U.getElements().length > 0 && z.getElements().length > 0) {
              let k = e(U, z, b, !0).changes;
              (R && (k = m(k)), (F = []));
              for (let O = 0, I = k.length; O < I; O++) F.push(c.createFromDiffChange(k[O], U, z));
            }
          }
              ...
              if (F !== U) {
                {
                  ...
                  (z > 1 || k > 1) &&
                    this._pushTrimWhitespaceCharChange(p, b + 1, 1, z, v + 1, 1, k);
                }
                {
                  let z = E(F, 1),
                    k = E(U, 1);
                  ...
                  (z < O || k < I) &&
                    this._pushTrimWhitespaceCharChange(p, b + 1, z, O, v + 1, k, I);
                }
              }
              (b++, v++);
            }
        ...
        static _createLink(a, u, c, m, f) {
          ...
          if (m > 0) {
            const w = u.charCodeAt(m - 1),
              E = u.charCodeAt(S);
            ((w === 40 && E === 41) || (w === 91 && E === 93) || (w === 123 && E === 125)) && S--;
          }
          return {
            range: { startLineNumber: c, startColumn: m + 1, endLineNumber: c, endColumn: S + 2 },
          ...
          for (let f = 1, S = a.getLineCount(); f <= S; f++) {
            ...
            for (; y < E; ) {
              ...
              if (s === 13) {
                ...
                let D;
                (N === 91 ? ((p = !0), (D = 0)) : (D = c.get(N)), D === 1 ? (R = !0) : (s = 13));
    ...
    X(J[53], Z([0, 1, 14]), function (q, n, M) {
      ...
      class a {
        constructor(m, f, S) {
          ((this.reverseEdits = m), (this.changes = f), (this.trimAutoWhitespaceLineNumbers = S));
        }
      }
    ...
    X(J[54], Z([0, 1, 7, 26]), function (q, n, M, A) {
      ...
      class i {
        ...
        _getPrefixSum(h) {
          ...
          for (let C = o; C <= h; C++) this.prefixSum[C] = this.prefixSum[C - 1] + this.values[C];
          return (
...
`) >= 0);
      ...
      class a {
        static findMatches(w, E, y, _, r) {
          ...
          return s
            ? s.regex.multiline
              ? this._doFindMatchesMultiline(w, y, new f(s.wordSeparators, s.regex), _, r)
...
`
          ...
          for (y.reset(0); (R = y.next(l)); )
            if (
              ((b[v++] = C(this._getMultilineMatchRange(w, s, l, p, R.index, R[0]), R, _)), v >= r)
            )
              return b;
          return b;
        }
        static _doFindMatchesLineByLine(w, E, y, _, r) {
          ...
          if (E.startLineNumber === E.endLineNumber) {
            ...
            return (
              (l = this._findMatchesInLine(y, b, E.startLineNumber, E.startColumn - 1, l, s, _, r)),
              s
            );
          }
          const p = w.getLineContent(E.startLineNumber).substring(E.startColumn - 1);
          l = this._findMatchesInLine(y, p, E.startLineNumber, E.startColumn - 1, l, s, _, r);
        ...
        static _findMatchesInLine(w, E, y, _, r, s, l, p) {
          ...
          if (!l && w.simpleSearch) {
            ...
            for (; (T = E.indexOf(N, T + D)) !== -1; )
              if (
                (!b || m(b, E, x, T, D)) &&
                ((s[r++] = new g.FindMatch(new d.Range(y, T + 1 + _, y, T + 1 + D + _), null)),
                r >= p)
              )
                return r;
            return r;
          ...
          do
            if (
              ...
              R &&
                ((s[r++] = C(
                  new d.Range(y, R.index + 1 + _, y, R.index + 1 + R[0].length + _),
                  R,
                  l,
                )),
                r >= p))
        ...
        static _doFindNextMatchMultiline(w, E, y, _) {
          const r = new i.Position(E.lineNumber, 1),
            s = w.getOffsetAt(r),
            l = w.getLineCount(),
            p = w.getValueInRange(new d.Range(r.lineNumber, r.column, l, w.getLineMaxColumn(l)), 1),
            b =
              w.getEOL() ===
              `\r
`
        ...
        static _findFirstMatchInLine(w, E, y, _, r) {
          w.reset(_ - 1);
          const s = w.next(E);
          return s ? C(new d.Range(y, s.index + 1, y, s.index + 1 + s[0].length), s, r) : null;
        }
        ...
        static _doFindPreviousMatchMultiline(w, E, y, _) {
          ...
          return E.lineNumber !== s || E.column !== w.getLineMaxColumn(s)
            ? this._doFindPreviousMatchMultiline(w, new i.Position(s, w.getLineMaxColumn(s)), y, _)
            : null;
        }
          ...
          e: for (let v = m, R = f; v <= R; v++) {
            ...
            do
              if (((s = y.next(N)), s)) {
                ...
                if (z !== 0) {
                  z === 3 ? l++ : z === 2 ? p++ : z === 1 ? b++ : (0, d.assertNever)(z);
                  const k = 1e3;
                  if (_.length >= k) {
                    r = !0;
                    break e;
        ...
        static computeUnicodeHighlightReason(a, u) {
          ...
          switch (c.shouldHighlightNonBasicASCII(a, null)) {
            ...
            case 3: {
              ...
              return { kind: 0, confusableWith: String.fromCodePoint(S), notAmbiguousInLocales: w };
            }
            case 1:
              return { kind: 2 };
          }
...
` ||
    ...
    X(J[17], Z([0, 1, 60]), function (q, n, M) {
      ...
      const _ =
          typeof ((A = y?.versions) === null || A === void 0 ? void 0 : A.electron) == 'string',
        r = _ && y?.type === 'renderer';
    ...
    X(J[63], Z([0, 1, 62]), function (q, n, M) {
      ...
      class a extends Error {
        constructor(s, l, p) {
          ...
          ((R += `. Received type ${typeof p}`), super(R), (this.code = 'ERR_INVALID_ARG_TYPE'));
        }
      }
      function u(r, s) {
              ...
              if (N === 2) {
                if (
                  ...
                  if (b.length > 2) {
                    ...
                    (T === -1
                      ? ((b = ''), (v = 0))
                      : ((b = b.slice(0, T)), (v = b.length - 1 - b.lastIndexOf(l))),
                      (R = x),
                      (N = 0));
                    continue;
                  } else if (b.length !== 0) {
                ...
                (b.length > 0 ? (b += `${l}${r.slice(R + 1, x)}`) : (b = r.slice(R + 1, x)),
                  (v = x - R - 1));
            ((R = x), (N = 0));
          } else D === L && N !== -1 ? ++N : (N = -1);
        }
      ...
      n.win32 = {
          ...
          for (let b = r.length - 1; b >= -1; b--) {
            ...
            if (b >= 0) {
              ...
              s.length === 0
                ...
                : ((v = M.env[`=${s}`] || M.cwd()),
                  (v === void 0 ||
                    (v.slice(0, 2).toLowerCase() !== s.toLowerCase() && v.charCodeAt(2) === o)) &&
                    (v = `${s}\\`));
            const R = v.length;
            let N = 0,
              D = '',
        ...
        normalize(r) {
          ...
          if (f(v))
            ...
            w(v) &&
              r.charCodeAt(1) === C &&
              ((p = r.slice(0, 2)), (l = 2), s > 2 && f(r.charCodeAt(2)) && ((b = !0), (l = 3)));
        ...
        join(...r) {
          ...
          if (typeof l == 'string' && f(l.charCodeAt(0))) {
            ++b;
            const v = l.length;
            v > 1 && f(l.charCodeAt(1)) && (++b, v > 2 && (f(l.charCodeAt(2)) ? ++b : (p = !1)));
          }
          if (p) {
        ...
        relative(r, s) {
          ...
          const l = n.win32.resolve(r),
            p = n.win32.resolve(s);
          if (l === p || ((r = l.toLowerCase()), (s = p.toLowerCase()), r === s)) return '';
          let b = 0;
          ...
          return (
            (N += F),
            z.length > 0 ? `${z}${p.slice(N, D)}` : (p.charCodeAt(N) === o && ++N, p.slice(N, D))
          );
        },
        toNamespacedPath(r) {
        ...
        dirname(r) {
          ...
          if (f(b)) {
            ...
            w(b) && r.charCodeAt(1) === C && ((l = s > 2 && f(r.charCodeAt(2)) ? 3 : 2), (p = l));
          let v = -1,
            R = !0;
          for (let N = s - 1; N >= p; --N)
            if (f(r.charCodeAt(N))) {
          ...
          if (
            ...
            for (v = r.length - 1; v >= l; --v) {
              ...
              if (f(D)) {
                ...
                (N === -1 && ((b = !1), (N = v + 1)),
                  R >= 0 && (D === s.charCodeAt(R) ? --R === -1 && (p = v) : ((R = -1), (p = N))));
            }
        ...
        extname(r) {
          ...
          for (let N = r.length - 1; N >= s; --N) {
            ...
            (b === -1 && ((v = !1), (b = N + 1)),
              D === L ? (l === -1 ? (l = N) : R !== 1 && (R = 1)) : l !== -1 && (R = -1));
          }
          return l === -1 || b === -1 || R === 0 || (R === 1 && l === b - 1 && l === p + 1)
            ? ''
            : r.slice(l, b);
        },
        format: y.bind(null, '\\'),
        parse(r) {
          ...
          let p = 0,
            b = r.charCodeAt(0);
          if (l === 1) return f(b) ? ((s.root = s.dir = r), s) : ((s.base = s.name = r), s);
          if (f(b)) {
      ...
      ((n.posix = {
        resolve(...r) {
          ...
          for (let p = r.length - 1; p >= -1 && !l; p--) {
            const b = p >= 0 ? r[p] : _();
            (c(b, 'path'), b.length !== 0 && ((s = `${b}/${s}`), (l = b.charCodeAt(0) === h)));
          }
        ...
        extname(r) {
          ...
          for (let R = r.length - 1; R >= 0; --R) {
            ...
            (p === -1 && ((b = !1), (p = R + 1)),
              N === L ? (s === -1 ? (s = R) : v !== 1 && (v = 1)) : s !== -1 && (v = -1));
          }
          return s === -1 || p === -1 || v === 0 || (v === 1 && s === p - 1 && s === l + 1)
            ? ''
            : r.slice(s, p);
        },
        format: y.bind(null, '/'),
        parse(r) {
          ...
          for (; D >= p; --D) {
            ...
            (R === -1 && ((N = !1), (R = D + 1)),
              T === L ? (b === -1 ? (b = D) : x !== 1 && (x = 1)) : b !== -1 && (x = -1));
          }
          if (R !== -1) {
            const T = v === 0 && l ? 1 : v;
            b === -1 || x === 0 || (x === 1 && b === R - 1 && b === v + 1)
              ? (s.base = s.name = r.slice(T, R))
              : ((s.name = r.slice(T, b)), (s.base = r.slice(T, R)), (s.ext = r.slice(b, R)));
          }
    ...
    X(J[18], Z([0, 1, 63, 17]), function (q, n, M, A) {
      ...
      class u {
        ...
        static parse(p, b = !1) {
          const v = a.exec(p);
          return v
            ? new m(v[2] || C, s(v[4] || C), s(v[5] || C), s(v[7] || C), s(v[9] || C), b)
            : new m(C, C, C, C, C);
        }
        static file(p) {
          let b = C;
        ...
        static joinPath(p, ...b) {
          if (!p.path) throw new Error('[UriError]: cannot call joinPath on URI without path');
          let v;
          return (
        ...
        static revive(p) {
          ...
          if (p) {
            if (p instanceof u) return p;
            {
              const R = new m(p);
              return (
                (R._formatted = (b = p.external) !== null && b !== void 0 ? b : null),
                (R._fsPath = p._sep === c && (v = p.fsPath) !== null && v !== void 0 ? v : null),
                R
              );
            }
          } else return p;
        ...
        if ((R && ((v += R), (v += ':')), (N || R === 'file') && ((v += e), (v += e)), N)) {
          ...
          if (F !== -1) {
            ...
            ((N = N.substr(F + 1)),
              ...
              F === -1
                ? (v += b(U, !1, !1))
                : ((v += b(U.substr(0, F), !1, !1)), (v += ':'), (v += b(U.substr(F + 1), !1, !0))),
              (v += '@'));
          }
          ((N = N.toLowerCase()),
            (F = N.lastIndexOf(':')),
    ...
    X(J[67], Z([0, 1, 5, 9, 13, 14, 17, 6]), function (q, n, M, A, i, d, g, L) {
      ...
      class a {
        constructor(l, p, b, v) {
          ((this.vsWorker = l), (this.seq = p), (this.res = b), (this.err = v), (this.type = 1));
        }
      }
      class u {
        constructor(l, p, b, v) {
      ...
      class f {
        ...
        listen(l, p) {
          ...
          const v = new A.Emitter({
            ...
            onDidRemoveLastListener: () => {
              (this._pendingEmitters.delete(b), this._send(new m(this._workerId, b)), (b = null));
            },
          });
          return v.event;
        }
          ...
          this._handler.handleMessage(l.method, l.args).then(
            ...
            (v) => {
              (v.detail instanceof Error &&
                ...
                this._send(
                  new a(this._workerId, p, void 0, (0, M.transformErrorForSerialization)(v)),
                ));
            },
          );
        }
              ...
              handleEvent: (F, U) => {
                if (E(F)) {
                  ...
                  if (typeof z != 'function')
                    throw new Error(`Missing dynamic event ${F} on main thread host.`);
                  return z;
                }
                if (w(F)) {
                  const z = b[F];
      ...
      class _ {
        ...
        _handleMessage(l, p) {
          ...
          try {
            return Promise.resolve(this._requestHandler[l].apply(this._requestHandler, p));
          } catch (b) {
        ...
        _handleEvent(l, p) {
          ...
          if (w(l)) {
            ...
            if (typeof b != 'function') throw new Error(`Missing event ${l} on request handler.`);
            return b;
          }
    ...
    X(J[65], Z([0, 1, 40, 18, 2, 59, 64]), function (q, n, M, A, i, d, g) {
      ...
      class L {
        constructor(l, p, b) {
          ((this.offset = l), (this.type = p), (this.language = b), (this._tokenBrand = void 0));
        }
        toString() {
      ...
      class h {
        constructor(l, p) {
          ((this.tokens = l), (this.endState = p), (this._tokenizationResultBrand = void 0));
        }
      }
      n.TokenizationResult = h;
      class o {
        constructor(l, p) {
          ((this.tokens = l), (this.endState = p), (this._encodedTokenizationResultBrand = void 0));
        }
      }
      ...
      class a {
        constructor(l, p, b, v) {
          ((this.range = l), (this.text = p), (this.completionKind = b), (this.isSnippetText = v));
        }
        equals(l) {
          return (
      ...
      function (q, n, M, A, i, d, g, L, h, o, C, e, a, u, c, m) {
        ...
        class f extends g.MirrorTextModel {
          ...
          findMatches(y) {
            ...
            for (let r = 0; r < this._lines.length; r++) {
              const s = this._lines[r],
                ...
                p = s.matchAll(y);
              for (const b of p) ((b.index || b.index === 0) && (b.index = b.index + l), _.push(b));
            }
            return _;
          }
          getLinesContent() {
          ...
          getWordAtPosition(y, _) {
            ...
            return r ? new d.Range(y.lineNumber, r.startColumn, y.lineNumber, r.endColumn) : null;
          }
          words(y) {
            const _ = this._lines,
              ...
              *[Symbol.iterator]() {
                for (;;)
                  if (p < b.length) {
                    ...
                    ((p += 1), yield v);
                  } else if (s < _.length) ((l = _[s]), (b = r(l, y)), (p = 0), (s += 1));
                  else break;
              },
            };
          }
          ...
          _validateRange(y) {
            const _ = this._validatePosition({
              ...
              r = this._validatePosition({ lineNumber: y.endLineNumber, column: y.endColumn });
        ...
        class S {
          ...
          async computeMoreMinimalEdits(y, _, r) {
            ...
            for (let v = 1; v < _.length; v++)
              d.Range.getEndPosition(_[b].range).equals(d.Range.getStartPosition(_[v].range))
            ...
            for (let { range: v, text: R, eol: N } of _) {
              if ((typeof N == 'number' && (p = N), d.Range.isEmpty(v) && !R)) continue;
            ...
            e: for (const v of y) {
              ...
              if (R) {
                for (const N of R.words(p))
                  if (!(N === _ || !isNaN(Number(N))) && (b.add(N), b.size > S._suggestionsLimit))
                    break e;
              }
            }
          ...
          async navigateValueSet(y, _, r, s, l) {
            ...
            const v = p.getValueInRange(_),
              R = p.getWordAtPosition({ lineNumber: _.startLineNumber, column: _.startColumn }, b);
            if (!R) return null;
          ...
          fmr(y, _) {
            if (!this._foreignModule || typeof this._foreignModule[y] != 'function')
              return Promise.reject(new Error('Missing requestHandler or method: ' + y));
            try {
              return Promise.resolve(this._foreignModule[y].apply(this._foreignModule, _));
            } catch (r) {
        ...
        ((n.create = w),
          typeof importScripts == 'function' && (globalThis.monaco = (0, C.createMonacoBaseAPI)()));
      },
    ));
}).call(this);
