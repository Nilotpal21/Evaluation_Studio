                  ...
                  : ((a = W.WithinTag),
                    ...
                    w < e.pos()
                      ? m(
                          w,
                          S.Unknown,
                          he('error.startTagNameExpected', 'Start tag name expected.'),
                        )
                      : E())
            );
          case W.WithinTag:
              ...
              for (var I in fe) {
                ...
                if (z === T) {
                  var v = fe[I].charCodeAt(0).toString(16).toUpperCase(),
                    k = 'U+';
                  if (v.length < 4)
                    for (var C = 4 - v.length, x = 0; x < C; ) ((k += '0'), (x += 1));
                  k += v;
                  var D = fi(
                    'entity.propose',
          ...
          function (e, a, c) {
            ...
            ((s.prototype = new l()),
              ...
              (s.prototype.read = function () {
                ...
                return (
                  this._until_after && (u += this._input.readUntilAfter(this._until_pattern)),
                  u
                );
              }),
