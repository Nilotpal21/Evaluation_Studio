        ...
        if (se(r.const)) {
          ...
          (Ie(P, r.const)
            ...
            : (i.problems.push({
                ...
                message:
                  r.errorMessage ||
                  M('constWarning', 'Value must be {0}.', JSON.stringify(r.const)),
              }),
              (i.enumValueMatch = !1)),
    ...
    function Or(t, r) {
      ...
      function c() {
        switch (a.getTokenError()) {
          case 4:
            return (
              u(M('InvalidUnicode', 'Invalid unicode sequence in string.'), W.InvalidUnicode),
              !0
            );
          case 5:
            return (
                ...
                if (typeof c == 'object' && !c.deprecationMessage && !c.doNotSuggest) {
                  var h = function (p, d) {
                    ...
                    var b = {
                      ...
                      filterText: o.getFilterTextForValue(p),
                      documentation:
                        d || o.fromMarkup(c.markdownDescription) || c.description || '',
                    };
