const errorMessages: Record<string, string> = {
  domain_not_allowed: 'Your email domain is not authorized to access this documentation.',
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold text-gray-900">Agent Platform v2</h1>
          <p className="mt-1 text-sm font-medium text-gray-500">Internal Documentation</p>
        </div>
