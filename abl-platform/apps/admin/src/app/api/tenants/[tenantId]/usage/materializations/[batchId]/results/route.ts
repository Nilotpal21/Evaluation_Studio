  ...
  async (
    ...
    try {
      const res = await fetch(
        `${getRuntimeBaseUrl()}/api/platform/admin/billing-policy/${encodeURIComponent(tenantId)}/materializations/${encodeURIComponent(batchId)}/results${searchParams ? `?${searchParams}` : ''}`,
        {
